            ...
            <ScrollView showsVerticalScrollIndicator={false} style={styles.container}>
                <View>
                    ...
                    <Text style={{
                        ...
                        alignSelf: 'center',
                        fontSize: 30
                    }}>{isLoggedIn ? 'Welcome to IPTV' : 'Login'}</Text>
                    {isLoggedIn && <TouchableOpacity style={styles.loginButton} onPress={handleLogout}>
                    ...
                    {!isLoggedIn && <View style={styles.formWrapper}>
                        <CustomTextInput
                            placeholder={'Email..'}
